...
# print(BASE_FILE)  D:\pingjia\iov\一期
...
#
trip_data_files = glob.glob(TRIP_FEATURE_DATA_FILE + "/*.csv")  #['D:\\pingjia\\iov\\一期/data/trip_feature\\*.csv']
charge_data_files = glob.glob(CHARGE_FEATURE_DATA_FILE + "/*.csv")  #['D:\\pingjia\\iov\\一期/data/charge_feature\\vin1.csv']
