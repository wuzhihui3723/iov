...
fig, ax = plt.subplots()
sns.set()
# ax.scatter(lift_curve_result_df.index.astype(str), lift_curve_result_df.y,
#            linewidths=2, label='real_value')
# ax.plot(lift_curve_result_df.index.astype(str), lift_curve_result_df.y)
# ax.scatter(lift_curve_result_df.index.astype(str), lift_curve_result_df.prediction,
#            linewidths=2, label='prediction')
# ax.plot(lift_curve_result_df.index.astype(str), lift_curve_result_df.prediction)
...
# for i, ax in zip(keep_col, axs.ravel()):
#     lift_curve_features = test_data.sort_values(i + '_clean')
#     lift_curve_features_result = lift_curve_features.groupby([i + '_bin']). \
#         agg({'y': 'mean',
#              'prediction': 'mean',
